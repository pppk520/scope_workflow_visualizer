...
#    cli()
    ...
    '''
    results = parse_script(r'D:\tmp/tt_all_2019-05-30\retail\amd64\Backend\DWC\DwcService\WorkflowGroups\ADC_AdvertiserIntelligence_Scope',
                           r'D:\tmp/tt_all_2019-05-30\retail\amd64\Backend\DWC\DwcService\WorkflowGroups\ADC_AdvertiserIntelligence_Scope',
                           r'D:\tmp/tt_tt',
                           target_date_str=DatetimeUtility.get_datetime(-6, fmt_str='%Y-%m-%d'),
                           target_filenames=['SOVBidMPIProcessing.script'])
    '''